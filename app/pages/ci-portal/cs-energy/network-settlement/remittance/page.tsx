...
export default function NetworkRemittancePage() {
  ...
  return (
    <CsPortalShell activeNavId="network-remittance">
      ...
      <h1 className="mb-density-lg text-density-3xl font-semibold text-cs-gray-900">
        Remittance
      </h1>
      ...
      <Card className="border-cs-gray-200 bg-white">
        <CardContent className="p-density-xl pt-density-xl">
          <div className="mb-density-lg flex flex-wrap items-end gap-density-md">
            ...
            <div className="w-52">
              <Select
                ...
                className="h-11 rounded-density-md border-cs-gray-300"
              >
            ...
            <button
              ...
              className="inline-flex h-11 items-center rounded-density-md border border-cs-gray-300 px-density-lg text-density-sm font-medium uppercase tracking-wide text-cs-gray-600 hover:bg-cs-gray-100"
            >
              Clear
            </button>
            <button
              ...
              className="inline-flex h-11 items-center gap-density-sm rounded-density-md border border-[var(--color-cs-success)] px-density-lg text-density-sm font-medium uppercase tracking-wide text-[var(--color-cs-success)] hover:bg-[color-mix(in_srgb,var(--color-cs-success)_8%,white)]"
            >
            ...
            <button
              ...
              className="ml-auto flex h-11 w-11 items-center justify-center rounded-density-md text-cs-gray-600 hover:bg-cs-gray-100"
            >
          ...
          <Table>
            <TableHeader>
              <TableRow className="border-cs-gray-200 hover:bg-transparent">
                ...
                <TableHead className="text-cs-gray-600">Payment date</TableHead>
                <TableHead className="text-cs-gray-600">Participant</TableHead>
                <TableHead className="text-cs-gray-600">
                  Payment reference
                </TableHead>
                <TableHead className="text-cs-gray-600">
                  No. of invoices
                </TableHead>
                <TableHead className="text-cs-gray-600">Status</TableHead>
                <TableHead className="text-right text-cs-gray-600">
                  Amount incl. GST
                </TableHead>
                <TableHead className="text-cs-gray-600">Created on</TableHead>
                <TableHead className="text-cs-gray-600">Actions</TableHead>
                <TableHead className="text-cs-gray-600">Note</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {filtered.map((row) => (
                <TableRow key={row.id} className="border-cs-gray-200">
                  <TableCell>
                    <Checkbox
                  ...
                  <TableCell className="tabular-nums text-cs-gray-900">
                    {row.paymentDate}
                  </TableCell>
                  <TableCell className="text-cs-gray-900">
                    {row.participant}
                  </TableCell>
                  <TableCell className="tabular-nums text-cs-gray-600">
                    {row.reference}
                  </TableCell>
                  <TableCell className="tabular-nums text-cs-gray-900">
                  ...
                  <TableCell className="text-right tabular-nums text-cs-gray-900">
                  ...
                  <TableCell className="text-cs-gray-600">
                    {row.note || "—"}
                  </TableCell>
                </TableRow>
              ))}
          ...
          <div className="mt-density-lg flex flex-wrap items-center justify-end gap-density-lg text-density-sm text-cs-gray-600">
            ...
            <div className="flex items-center gap-density-xs">
              <button
                ...
                className="flex h-9 w-9 items-center justify-center rounded-density-md hover:bg-cs-gray-100"
                disabled
              >
      ...
      <Dialog open={wizardOpen} onOpenChange={setWizardOpen}>
        <DialogContent className="max-w-lg rounded-density-lg border-cs-gray-200">
          <DialogHeader>
            <DialogTitle className="text-cs-blue-800">
          ...
          <div className="flex justify-end gap-density-md">
            ...
            <button
              type="button"
              className="inline-flex h-11 items-center rounded-density-md border border-cs-blue-800 px-density-lg text-density-sm font-medium uppercase tracking-wide text-cs-blue-800 hover:bg-cs-blue-50"
            >
              Next
            </button>
          </div>
          <DialogClose aria-label="Close">
            <Icon name="close" size={ICON_LG} className="text-cs-gray-600" />
          </DialogClose>
        </DialogContent>
      </Dialog>
    </CsPortalShell>
