...
export const brand = getClientBrand("cs-energy");
export const { colours, chart } = brand;

export const [ACCENT, BLUE_MID, BLUE_LINK, CYAN_FILL, NEUTRAL] =
  chart.series;
...
export const HOME_HREF = "/pages/ci-portal/cs-energy";
export const ACCOUNTS_HREF = "/pages/ci-portal/cs-energy/accounts";
export const SETTLEMENTS_HREF = "/pages/ci-portal/cs-energy/settlements";
export const SETTLEMENT_CASE_HREF =
  "/pages/ci-portal/cs-energy/settlements/cases/11755";
export const NETWORK_SETTLEMENT_HREF =
  "/pages/ci-portal/cs-energy/network-settlement";
export const NETWORK_REMITTANCE_HREF =
  "/pages/ci-portal/cs-energy/network-settlement/remittance";
...
export const ACCOUNT = {
  id: "100001",
  name: "CS Energy — Commercial Portfolio",
  balance: 31562307.28,
  status: "Active",
  serviceType: "Unknown",
  billingAddressee: "",
  billingAddress: "Level 12, 31 Duncan Street, Fortitude Valley QLD 4006",
  isParent: true,
  contact: {
    type: "Primary",
    fullName: "Alex Chen",
    ...
    landline: "",
    mobile: "",
    email: "ci.portal@csenergy.com.au",
    address: "Level 12, 31 Duncan Street, Fortitude Valley QLD 4006",
  },
  business: {
    name: "CS Energy Ltd",
    abn: "",
...
export function CsPortalShell({
  ...
  return (
    <div
      className="cs-brand flex h-screen flex-col bg-cs-gray-25 text-cs-gray-900"
      style={{ fontFamily: brand.fontFamily }}
    >
      <header className="flex h-14 shrink-0 items-center gap-density-md bg-cs-blue-800 pl-density-sm text-white">
        <button
          type="button"
        ...
        <Link
          ...
          aria-label="CS Energy C&I Portal home"
        >
          <Image
        ...
        <div className="ml-auto flex items-center gap-density-sm">
          ...
          >
            ...
            <span className="absolute right-2.5 top-2.5 h-1.5 w-1.5 rounded-full bg-cs-acc-300" />
          </button>
          ...
          <div className="flex h-14 w-14 items-center justify-center bg-cs-blue-950 text-density-base font-medium text-white">
            RR
          </div>
        </div>
      </header>
