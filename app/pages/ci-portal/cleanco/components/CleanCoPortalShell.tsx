...
export const brand = getClientBrand("cleanco");
export const { colours, chart } = brand;

export const [ACCENT, CYAN_MID, CYAN_MARK, CYAN_LIGHT, NEUTRAL] =
  chart.series;
...
export const HOME_HREF = "/pages/ci-portal/cleanco";
export const ACCOUNTS_HREF = "/pages/ci-portal/cleanco/accounts";
export const SETTLEMENTS_HREF = "/pages/ci-portal/cleanco/settlements";
export const SETTLEMENT_CASE_HREF =
  "/pages/ci-portal/cleanco/settlements/cases/11755";
export const NETWORK_SETTLEMENT_HREF =
  "/pages/ci-portal/cleanco/network-settlement";
export const NETWORK_REMITTANCE_HREF =
  "/pages/ci-portal/cleanco/network-settlement/remittance";
...
export const ACCOUNT = {
  id: "100001",
  name: "CleanCo — Swanbank Power Station",
  balance: 31562307.28,
  status: "Active",
  serviceType: "Unknown",
  billingAddressee: "",
  billingAddress: "Level 32, 1 Eagle Street, Brisbane QLD 4000",
  isParent: true,
  contact: {
    type: "Primary",
    ...
    landline: "",
    mobile: "",
    email: "ci.portal@cleancoqueensland.com.au",
    address: "Level 32, 1 Eagle Street, Brisbane QLD 4000",
  },
  business: {
...
export function CleanCoPortalShell({
  activeNavId,
  children,
}: {
  activeNavId: string;
  ...
  return (
    <div
      className="cleanco-brand flex h-screen flex-col bg-cleanco-gray-25 text-cleanco-gray-900"
      style={{ fontFamily: brand.fontFamily }}
    >
      <header className="flex h-14 shrink-0 items-center gap-density-md bg-cleanco-cyan-800 pl-density-sm text-white">
        <button
          type="button"
        ...
        <Link
          ...
          aria-label="CleanCo C&I Portal home"
        >
          <Image
        ...
        <div className="ml-auto flex items-center gap-density-sm">
          ...
          >
            ...
            <span className="absolute right-2.5 top-2.5 h-1.5 w-1.5 rounded-full bg-cleanco-cyan-700" />
          </button>
          ...
          <div className="flex h-14 w-14 items-center justify-center bg-cleanco-cyan-950 text-density-base font-medium text-white">
            RR
          </div>
        </div>
      </header>
