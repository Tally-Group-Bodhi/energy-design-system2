...
import { CleanCoDatePicker } from "../../components/CleanCoDatePicker";
import {
  Breadcrumb,
  BreadcrumbList,
  BreadcrumbItem,
...
export default function NetworkRemittancePage() {
  ...
  return (
    <CleanCoPortalShell activeNavId="network-remittance">
      ...
      <h1 className="mb-density-lg text-density-3xl font-semibold text-cleanco-gray-900">
        Remittance
      </h1>
      ...
      <Card className="border-cleanco-gray-200 bg-white">
        <CardContent className="p-density-xl pt-density-xl">
          <div className="mb-density-lg flex flex-wrap items-end gap-density-md">
            ...
            <div className="w-52">
              <Select
                ...
                className="h-11 rounded-density-md border-cleanco-gray-300"
              >
            ...
            <button
              ...
              className="inline-flex h-11 items-center rounded-density-md border border-cleanco-gray-300 px-density-lg text-density-sm font-medium uppercase tracking-wide text-cleanco-gray-700 hover:bg-cleanco-gray-100"
            >
              Clear
            </button>
            <button
              ...
              className="inline-flex h-11 items-center gap-density-sm rounded-density-md border border-[var(--color-cleanco-success)] px-density-lg text-density-sm font-medium uppercase tracking-wide text-[var(--color-cleanco-success)] hover:bg-[color-mix(in_srgb,var(--color-cleanco-success)_8%,white)]"
            >
            ...
            <button
              ...
              className="ml-auto flex h-11 w-11 items-center justify-center rounded-density-md text-cleanco-gray-700 hover:bg-cleanco-gray-100"
            >
          ...
          <Table>
            <TableHeader>
              <TableRow className="border-cleanco-gray-200 hover:bg-transparent">
                ...
                <TableHead className="text-cleanco-gray-700">Payment date</TableHead>
                <TableHead className="text-cleanco-gray-700">Participant</TableHead>
                <TableHead className="text-cleanco-gray-700">
                  Payment reference
                </TableHead>
                <TableHead className="text-cleanco-gray-700">
                  No. of invoices
                </TableHead>
                <TableHead className="text-cleanco-gray-700">Status</TableHead>
                <TableHead className="text-right text-cleanco-gray-700">
                  Amount incl. GST
                </TableHead>
                <TableHead className="text-cleanco-gray-700">Created on</TableHead>
                <TableHead className="text-cleanco-gray-700">Actions</TableHead>
                <TableHead className="text-cleanco-gray-700">Note</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {filtered.map((row) => (
                <TableRow key={row.id} className="border-cleanco-gray-200">
                  <TableCell>
                    <Checkbox
                  ...
                  <TableCell className="tabular-nums text-cleanco-gray-900">
                    {row.paymentDate}
                  </TableCell>
                  <TableCell className="text-cleanco-gray-900">
                    {row.participant}
                  </TableCell>
                  <TableCell className="tabular-nums text-cleanco-gray-700">
                    {row.reference}
                  </TableCell>
                  <TableCell className="tabular-nums text-cleanco-gray-900">
                    <span className="inline-flex items-center gap-1">
                      ...
                      <Icon
                        name="arrow_upward"
                        size={14}
                        className="text-cleanco-cyan-700"
                      />
                    </span>
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell className="text-right tabular-nums text-cleanco-gray-900">
                  ...
                  <TableCell className="text-cleanco-gray-700">
                    {row.note || "—"}
                  </TableCell>
                </TableRow>
              ))}
          ...
          <div className="mt-density-lg flex flex-wrap items-center justify-end gap-density-lg text-density-sm text-cleanco-gray-700">
            ...
            <div className="flex items-center gap-density-xs">
              <button
                ...
                className="flex h-9 w-9 items-center justify-center rounded-density-md hover:bg-cleanco-gray-100"
                disabled
              >
      ...
      <Dialog open={wizardOpen} onOpenChange={setWizardOpen}>
        <DialogContent className="max-w-lg rounded-density-lg border-cleanco-gray-200">
          <DialogHeader>
            <DialogTitle className="text-cleanco-cyan-950">
          ...
          <div className="flex justify-end gap-density-md">
            ...
            <button
              type="button"
              className="inline-flex h-11 items-center rounded-density-md border border-cleanco-cyan-950 px-density-lg text-density-sm font-medium uppercase tracking-wide text-cleanco-cyan-950 hover:bg-cleanco-cyan-50"
            >
              Next
            </button>
          </div>
          <DialogClose aria-label="Close">
            <Icon name="close" size={ICON_LG} className="text-cleanco-gray-700" />
          </DialogClose>
        </DialogContent>
      </Dialog>
    </CleanCoPortalShell>
