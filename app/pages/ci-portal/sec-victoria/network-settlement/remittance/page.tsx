...
export default function NetworkRemittancePage() {
  ...
  return (
    <SecPortalShell activeNavId="network-remittance">
      ...
      <h1 className="mb-density-lg text-density-3xl font-semibold text-sec-gray-900">
        Remittance
      </h1>
        ...
        <CardContent className="p-density-xl pt-density-xl">
          <div className="mb-density-lg flex flex-wrap items-end gap-density-md">
            ...
            <button
              ...
              className="inline-flex h-11 items-center rounded-density-md border border-sec-gray-300 px-density-lg text-density-sm font-medium uppercase tracking-wide text-sec-gray-600 hover:bg-sec-gray-100"
            >
              Clear
            </button>
            <button
              ...
              className="inline-flex h-11 items-center gap-density-sm rounded-density-md border border-[var(--color-sec-success)] px-density-lg text-density-sm font-medium uppercase tracking-wide text-[var(--color-sec-success)] hover:bg-[color-mix(in_srgb,var(--color-sec-success)_8%,white)]"
            >
            ...
            <button
              ...
              className="ml-auto flex h-11 w-11 items-center justify-center rounded-density-md text-sec-gray-600 hover:bg-sec-gray-100"
            >
          ...
          <Table>
            <TableHeader>
              <TableRow className="border-sec-gray-200 hover:bg-transparent">
                ...
                <TableHead className="text-sec-gray-600">Payment date</TableHead>
                <TableHead className="text-sec-gray-600">Participant</TableHead>
                <TableHead className="text-sec-gray-600">
                  Payment reference
                </TableHead>
                <TableHead className="text-sec-gray-600">
                  No. of invoices
                </TableHead>
                <TableHead className="text-sec-gray-600">Status</TableHead>
                <TableHead className="text-right text-sec-gray-600">
                  Amount incl. GST
                </TableHead>
                <TableHead className="text-sec-gray-600">Created on</TableHead>
                <TableHead className="text-sec-gray-600">Actions</TableHead>
                <TableHead className="text-sec-gray-600">Note</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {filtered.map((row) => (
                <TableRow key={row.id} className="border-sec-gray-200">
                  <TableCell>
                    <Checkbox
                  ...
                  <TableCell className="tabular-nums text-sec-gray-900">
                    {row.paymentDate}
                  </TableCell>
                  <TableCell className="text-sec-gray-900">
                    {row.participant}
                  </TableCell>
                  <TableCell className="tabular-nums text-sec-gray-600">
                    {row.reference}
                  </TableCell>
                  <TableCell className="tabular-nums text-sec-gray-900">
                  ...
                  <TableCell className="text-right tabular-nums text-sec-gray-900">
                  ...
                  <TableCell className="text-sec-gray-600">
                    {row.note || "—"}
                  </TableCell>
                </TableRow>
              ))}
          ...
          <div className="mt-density-lg flex flex-wrap items-center justify-end gap-density-lg text-density-sm text-sec-gray-600">
            ...
            <div className="flex items-center gap-density-xs">
              <button
                ...
                className="flex h-9 w-9 items-center justify-center rounded-density-md hover:bg-sec-gray-100"
                disabled
              >
      ...
      <Dialog open={wizardOpen} onOpenChange={setWizardOpen}>
        <DialogContent className="max-w-lg rounded-density-lg border-sec-gray-200">
          <DialogHeader>
            <DialogTitle className="text-sec-purple-950">
          ...
          <div className="flex justify-end gap-density-md">
            ...
            <button
              type="button"
              className="inline-flex h-11 items-center rounded-density-md border border-sec-purple-950 px-density-lg text-density-sm font-medium uppercase tracking-wide text-sec-purple-950 hover:bg-sec-purple-50"
            >
              Next
            </button>
          </div>
