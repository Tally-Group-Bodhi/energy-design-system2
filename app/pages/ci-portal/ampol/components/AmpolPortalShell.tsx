...
export const brand = getClientBrand("ampol");
export const { colours, chart } = brand;

export const [ACCENT, BLUE_MID, BLUE_DEEP, BLUE_LIGHT, NEUTRAL] =
  chart.series;
...
export const HOME_HREF = "/pages/ci-portal/ampol";
export const ACCOUNTS_HREF = "/pages/ci-portal/ampol/accounts";
export const SETTLEMENTS_HREF = "/pages/ci-portal/ampol/settlements";
export const SETTLEMENT_CASE_HREF =
  "/pages/ci-portal/ampol/settlements/cases/11755";
export const NETWORK_SETTLEMENT_HREF =
  "/pages/ci-portal/ampol/network-settlement";
export const NETWORK_REMITTANCE_HREF =
  "/pages/ci-portal/ampol/network-settlement/remittance";
...
export const ACCOUNT = {
  id: "100001",
  name: "Ampol Refining — Lytton",
  balance: 31562307.28,
  status: "Active",
  serviceType: "Unknown",
  billingAddressee: "",
  billingAddress: "29-33 Newton Road, Wetherill Park NSW 2164",
  isParent: true,
  contact: {
    type: "Primary",
    fullName: "Alex Chen",
    ...
    landline: "",
    mobile: "",
    email: "ci.portal@ampol.com.au",
    address: "29-33 Newton Road, Wetherill Park NSW 2164",
  },
  business: {
    name: "Ampol Limited",
    abn: "",
...
export function AmpolPortalShell({
  activeNavId,
  children,
}: {
  activeNavId: string;
  ...
  return (
    <div
      className="ampol-brand flex h-screen flex-col bg-ampol-gray-25 text-ampol-gray-900"
      style={{ fontFamily: brand.fontFamily }}
    >
      <header className="flex h-14 shrink-0 items-center gap-density-md bg-ampol-blue-800 pl-density-sm text-white">
        <button
          type="button"
        ...
        <Link
          ...
          aria-label="Ampol C&I Portal home"
        >
          <Image
        ...
        <div className="ml-auto flex items-center gap-density-sm">
          ...
          >
            ...
            <span className="absolute right-2.5 top-2.5 h-1.5 w-1.5 rounded-full bg-ampol-red-600" />
          </button>
          ...
          <div className="flex h-14 w-14 items-center justify-center bg-ampol-blue-950 text-density-base font-medium text-white">
            RR
          </div>
        </div>
      </header>
