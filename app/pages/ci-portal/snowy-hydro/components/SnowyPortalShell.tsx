...
export const brand = getClientBrand("snowy-hydro");
export const { colours, chart } = brand;

export const [ACCENT, BLUE, PURPLE, SLATE, NEUTRAL] =
  chart.series;
...
export const HOME_HREF = "/pages/ci-portal/snowy-hydro";
export const ACCOUNTS_HREF = "/pages/ci-portal/snowy-hydro/accounts";
export const SETTLEMENTS_HREF = "/pages/ci-portal/snowy-hydro/settlements";
export const SETTLEMENT_CASE_HREF =
  "/pages/ci-portal/snowy-hydro/settlements/cases/11755";
export const NETWORK_SETTLEMENT_HREF =
  "/pages/ci-portal/snowy-hydro/network-settlement";
export const NETWORK_REMITTANCE_HREF =
  "/pages/ci-portal/snowy-hydro/network-settlement/remittance";
...
export const ACCOUNT = {
  id: "100001",
  name: "Snowy Hydro — Commercial Portfolio",
  balance: 31562307.28,
  status: "Active",
  serviceType: "Unknown",
  billingAddressee: "",
  billingAddress: "Monaro Highway, Cooma NSW 2630",
  isParent: true,
  contact: {
    type: "Primary",
    ...
    landline: "",
    mobile: "",
    email: "ci.portal@snowyhydro.com.au",
    address: "Monaro Highway, Cooma NSW 2630",
  },
  business: {
...
export function SnowyPortalShell({
  activeNavId,
  children,
}: {
  activeNavId: string;
  ...
  return (
    <div
      className="snowy-brand flex h-screen flex-col bg-snowy-gray-25 text-snowy-gray-900"
      style={{ fontFamily: brand.fontFamily }}
    >
      <header className="flex h-14 shrink-0 items-center gap-density-md bg-snowy-teal-800 pl-density-sm text-white">
        <button
          type="button"
        ...
        <Link
          ...
          aria-label="Snowy Hydro C&I Portal home"
        >
          <Image
        ...
        <div className="ml-auto flex items-center gap-density-sm">
          ...
          >
            ...
            <span className="absolute right-2.5 top-2.5 h-1.5 w-1.5 rounded-full bg-snowy-acc-600" />
          </button>
          ...
          <div className="flex h-14 w-14 items-center justify-center bg-snowy-teal-950 text-density-base font-medium text-white">
            RR
          </div>
        </div>
      </header>
