              ...
              <div className="flex flex-1 flex-col overflow-y-auto">
                ...
                <div className="flex items-center gap-1 px-3 pt-3 pb-2">
                  <div className="flex flex-1 gap-1">
                    {PANEL_TABS.map((tab) => (
                      ...
                      >
                        {tab === "Adora" ? (
                          <Image src="/AdoraTab.svg" alt="Adora" width={72} height={24} className="h-6 w-auto" />
                        ) : tab}
                      </button>
                    ))}
                  </div>
                ...
                {activePanelTab === "Adora" && (
                  <div className="flex flex-1 flex-col overflow-y-auto px-3.5 py-3.5">
                    <span className="mb-3 text-sm font-bold tracking-tight text-gray-900 dark:text-slate-100">
                      Customer Summary
                    </span>
                    <Badge className="mb-3 w-fit border-[#00D2A2]/40 bg-[#00D2A2]/10 text-[10px] font-medium text-[#008f6f] dark:border-[#00D2A2]/30 dark:bg-[#00D2A2]/15 dark:text-[#00D2A2]">
                      Auto-generated
                    </Badge>
                    <div className="rounded-xl border border-orange-300/80 p-3 dark:border-orange-500/40">
                      ...
                      {(adoraPhase === "typing" || adoraPhase === "done") && (
                        <p className="text-xs leading-relaxed text-gray-700 dark:text-slate-300">
                          ...
                          {adoraPhase === "typing" && (
                            <span className="ml-0.5 inline-block h-3.5 w-[2px] animate-pulse bg-orange-400 align-middle" />
                          )}
                        </p>
                      )}
                    </div>
                    {adoraPhase === "done" && (
                      <button
                        type="button"
                        className="mt-3 inline-flex items-center gap-1.5 self-start rounded-full bg-orange-400 px-3 py-1 text-xs font-semibold text-white transition-all hover:bg-orange-500"
                      >
                        <Image src="/AdoraDot.svg" alt="" width={14} height={14} className="h-3.5 w-3.5" />
                        Ask Adora
                      </button>
