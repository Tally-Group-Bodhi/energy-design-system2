...
const LOGO_BASE = "/foundation/brands/tally-crm";

const logos = [
  { name: "Primary (full colour)", file: "TallyCRMLogo.svg", bg: "bg-white", label: "Light background" },
  { name: "Reversed (full colour)", file: "TallyCRMLogoReversed.svg", bg: "bg-[#006180]", label: "Dark background" },
  { name: "Mono (single colour)", file: "TallyCRMLogoMono.svg", bg: "bg-white", label: "Light background" },
  { name: "Mono reversed", file: "TallyCRMMonoReversed.svg", bg: "bg-[#006180]", label: "Dark background" },
] as const;

const crmPalette = [
  { name: "Lighter", hex: "#E6F7FF" },
  { name: "Light", hex: "#80E0FF" },
  { name: "Blue", hex: "#00C1FF" },
  { name: "Dark", hex: "#0091BF" },
  { name: "Darker", hex: "#006180" },
];
...
const crmBottomItems: NavigationItem[] = [
  { id: "help", label: "Help", href: "#", icon: "help" },
  { id: "settings", label: "Settings", href: "#", icon: "settings" },
];

// Use Darker (#006180) for fonts and icons whenever Lighter/Light is used as background (accessibility).
const crmActiveColors = {
  bg: "bg-[#E6F7FF]",
  text: "text-[#006180]",
...
const BRAND_BLUE = "#00C1FF";
const DARKER = "#006180";
const DARK = "#0091BF";

export default function TallyCRMPage() {
  return (
    <>
      <PageBanner title="Tally CRM" />

      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          <div className="mb-12">
            <p className="max-w-3xl text-lg leading-7 text-gray-600 dark:text-gray-400">
              Color is key to the immediate brand recognition of our suite of products. The products powered by Tally CRM are distinguishable by their dedicated brand colors.
            </p>
          </div>
          ...
          <section className="mb-16 border-t border-border pt-16">
            ...
            <p className="mb-6 max-w-3xl text-base text-gray-600 dark:text-gray-400">
              Use the official Tally CRM logo in the correct variant for your background. Download the asset you need below.
            </p>
          ...
          <section className="mb-16 border-t border-border pt-20">
            ...
            <p className="mb-8 max-w-3xl text-base text-gray-600 dark:text-gray-400">
              Tally CRM UI palette for navigation, headers, buttons, and surfaces. Based on #00C1FF.
            </p>
            <div className="flex flex-col rounded-lg overflow-hidden sm:flex-row">
              {crmPalette.map((c) => {
                const useLightText = [BRAND_BLUE, DARK, DARKER].includes(c.hex);
                return (
                  <div
                    key={c.hex}
          ...
          <section className="mb-16 border-t border-border pt-16">
            ...
            <ul className="list-inside list-disc space-y-2 text-gray-600 dark:text-gray-400">
              <li>Use blue (#00C1FF) for primary actions, selected states, and key UI anchors.</li>
              <li>Use <strong>Darker (#006180)</strong> for all text and icons on Lighter or Light backgrounds (e.g. active nav) for contrast.</li>
              <li>Reserve brand colour for one primary CTA or active nav item rather than many.</li>
              <li>Avoid full-width or large blocks of blue; use for buttons, icons, and highlights.</li>
          ...
          <section className="mb-16 border-t border-border pt-16">
            ...
            <p className="mb-8 max-w-3xl text-base text-gray-600 dark:text-gray-400">
              Examples of using Tally CRM colours for buttons, selected states, navigation, and app layout.
            </p>
            ...
            <div className="mt-10">
              <Card className="overflow-hidden shadow-none">
                <CardHeader>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Tally Acquire–style nav bar with Tally CRM logo. A 4px brand colour line sits above the app bar; content area stays neutral.
                  </p>
                </CardHeader>
                  ...
                  <div className="rounded-lg border border-gray-200 overflow-hidden dark:border-gray-700">
                    ...
                    <header className="flex h-14 shrink-0 items-center gap-4 border-b border-border bg-white px-6 dark:border-gray-800 dark:bg-gray-950/90">
                      <div className="flex items-center gap-4">
                        <Link href="/foundation/brands/tally-crm" className="flex items-center">
                          <Image
                            src={`${LOGO_BASE}/TallyCRMLogo.svg`}
                            alt="Tally CRM"
                            width={140}
                            height={28}
                          ...
                          />
                          <Image
                            src={`${LOGO_BASE}/TallyCRMLogoReversed.svg`}
                            alt="Tally CRM"
                            width={140}
                            height={28}
                      ...
                      <div className="flex flex-1 justify-center">
                        <div className="relative hidden w-full max-w-md md:block">
                          ...
                          <input
                            type="search"
                            placeholder="Search"
                            className="h-10 w-full rounded-lg border border-border bg-gray-50 pl-10 pr-3 text-sm text-gray-900 placeholder:text-gray-500 focus:border-[#00C1FF] focus:outline-none focus:ring-1 focus:ring-[#00C1FF] dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100"
                          />
                        </div>
                      </div>
                    ...
                    <div className="flex">
                      <aside className="flex w-48 shrink-0 flex-col border-r border-border bg-white dark:border-gray-800 dark:bg-gray-950">
                        <nav className="flex flex-col gap-1 p-2">
                          <div className="mx-2 rounded-lg bg-[#E6F7FF] px-3 py-2.5 text-sm font-medium text-[#006180] dark:bg-[#006180]/20 dark:text-[#80E0FF]">
                            Home
                          </div>
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
              <div className="rounded-lg border border-border bg-white dark:border-gray-700 dark:bg-gray-800/50">
                ...
                <div className="flex min-h-[420px]">
                  <NavigationBar
                    items={crmNavItems}
                    bottomItems={crmBottomItems}
                    defaultActiveId="home"
                    collapsed={true}
                    onCollapsedChange={() => {}}
                    compact
                    activeColors={crmActiveColors}
                  />
              ...
              <div className="rounded-lg border border-border bg-white dark:border-gray-700 dark:bg-gray-800/50">
                <div className="border-b border-border px-4 py-3 dark:border-gray-700">
                  ...
                  <p className="mt-0.5 text-xs text-muted-foreground">
                    Active background Lighter (#E6F7FF); icons and text use Darker (#006180).
                  </p>
                </div>
                <div className="flex min-h-[420px]">
                  <NavigationBar
          ...
          <div className="border-t border-border pt-8">
            <Link
              ...
              className="text-sm font-medium text-[#006180] hover:underline dark:text-[#80E0FF]"
            >
              ← Back to Brands
            </Link>
          </div>
